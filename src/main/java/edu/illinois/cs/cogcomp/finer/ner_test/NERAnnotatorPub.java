package edu.illinois.cs.cogcomp.finer.ner_test;
 ...
 * @author redman
 */
public class NERAnnotatorPub extends Annotator {

    /** POS, shallow parsing are NOT required. */
//    private static final String[] REQUIRED_VIEWS = {};
    /** our specific logger. */
    private final Logger logger = LoggerFactory.getLogger(NERAnnotatorPub.class);
     ...
     */
    public NERAnnotatorPub(String nonDefaultConfigValues, String viewName) throws IOException {
     ...
     * @throws IOException
     */
    public NERAnnotatorPub(String viewName) throws IOException {
     ...
     */
    public NERAnnotatorPub(ResourceManager nonDefaultRm, String viewName) {
    ...
    public void addView(TextAnnotation ta) {
        ...
        ArrayList<LinkedVector> sentences = new ArrayList<LinkedVector>();
