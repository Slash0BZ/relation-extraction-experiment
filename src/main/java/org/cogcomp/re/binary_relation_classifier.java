...
public class binary_relation_classifier extends SupportVectorMachine
{
  private static void loadInstance()
  {
    if (instance == null) instance = new binary_relation_classifier(true);
  }

  public static Parser getParser() { return new ACEMentionReader("data/partition/train/0", "relation_full_bi_test"); }
  public static Parser getTestParser() { return new ACEMentionReader("data/partition/eval/0", "relation_full_bi_test"); }

  public static boolean isTraining;
  public static binary_relation_classifier instance;

  public static binary_relation_classifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private binary_relation_classifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "org.cogcomp.re";
    name = "binary_relation_classifier";
    setEncoding(null);
    setLabeler(new is_null_label());
    setExtractor(new binary_relation_classifier$$1());
    isClone = false;
  }
  ...
  public binary_relation_classifier()
  {
    super("org.cogcomp.re.binary_relation_classifier");
    isClone = true;
  }

  public binary_relation_classifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public binary_relation_classifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(binary_relation_classifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(binary_relation_classifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(binary_relation_classifier.class, lexiconPath));
    }
    else {
      containingPackage = "org.cogcomp.re";
      name = "binary_relation_classifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Relation || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'binary_relation_classifier(Relation)' defined on line 143 of re.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: org.cogcomp.re.binary_relation_classifier \\");
  ...
  public int hashCode() { return "binary_relation_classifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof binary_relation_classifier; }
