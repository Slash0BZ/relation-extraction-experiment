...
// 
...
public class entity_subtype_classifier extends SupportVectorMachine
{
  ...
  static
  {
    _lcFilePath = entity_subtype_classifier.class.getResource("entity_subtype_classifier.lc");
    _lexFilePath = entity_subtype_classifier.class.getResource("entity_subtype_classifier.lex");
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      if (_lcFilePath == null)
      {
        throw new RuntimeException("Can't locate entity_subtype_classifier.lc in the class path.");
      }
      if (_lexFilePath == null)
      {
        throw new RuntimeException("Can't locate entity_subtype_classifier.lc in the class path.");
      }
      instance = (entity_subtype_classifier) Learner.readLearner(_lcFilePath);
      instance.readLexiconOnDemand(_lexFilePath);
    }
  }

  public static Parser getParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("C:\\Users\\xuany\\Dropbox\\research\\relation-extraction\\src\\main\\java\\org\\cogcomp\\re\\entity_subtype_classifier.ex"); }
  public static Parser getTestParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("C:\\Users\\xuany\\Dropbox\\research\\relation-extraction\\src\\main\\java\\org\\cogcomp\\re\\entity_subtype_classifier.test.ex"); }
  public static boolean isTraining;
  public static entity_subtype_classifier instance;

  public static entity_subtype_classifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private entity_subtype_classifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "org.cogcomp.re";
    name = "entity_subtype_classifier";
    setEncoding(null);
    setLabeler(new entity_subtype());
    setExtractor(new entity_subtype_classifier$$1());
    isClone = false;
  }
  ...
  public entity_subtype_classifier()
  {
    super("org.cogcomp.re.entity_subtype_classifier");
    isClone = true;
  }

  public entity_subtype_classifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public entity_subtype_classifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(entity_subtype_classifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(entity_subtype_classifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(entity_subtype_classifier.class, lexiconPath));
    }
    else {
      containingPackage = "org.cogcomp.re";
      name = "entity_subtype_classifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Constituent || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'entity_subtype_classifier(Constituent)' defined on line 51 of PMS_sup.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: org.cogcomp.re.entity_subtype_classifier \\");
    ...
    entity_subtype_classifier classifier = new entity_subtype_classifier();
  ...
  public int hashCode() { return "entity_subtype_classifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof entity_subtype_classifier; }
