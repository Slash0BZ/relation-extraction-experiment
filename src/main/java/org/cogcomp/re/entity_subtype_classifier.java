...
public class entity_subtype_classifier extends SupportVectorMachine
{
  ...
  {
    if (instance == null) instance = new entity_subtype_classifier(true);
  }

  public static Parser getParser() { return new ACEMentionReader("data/original", "entity"); }
  public static Parser getTestParser() { return new ACEMentionReader("data/original", "entity"); }
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Constituent || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'entity_subtype_classifier(Constituent)' defined on line 60 of PMS_sup.lbj received '" + type + "' as input.");
